/**
 * Supplier Page — Thin wrapper around Generic CRUD Module.
 */
import { CrudModule } from "@smart/ui";
import { listSupplier, getSupplier, createSupplier, updateSupplier, deleteSupplier } from "../../data/index.js";
import { checkKodeExists } from "../../data/supplier-data.js";

const { CrudPage, initCrudPage } = CrudModule({
    entityId: "supplier",
    title: "Master Supplier",
    subtitle: "Kelola data pemasok barang",
    icon: "🏭",
    singularName: "Supplier",
    pluralName: "supplier",
    tambahLabel: "Tambah Supplier",
    formTitleEdit: "Edit Supplier",
    formTitleCreate: "Tambah Supplier Baru",
    services: { list: listSupplier, get: getSupplier, create: createSupplier, update: updateSupplier, delete: deleteSupplier, checkKodeExists },
    columns: [
    ...
    renderFormFields: (e, d) => `
        <div class="form-grid">
            <div class="form-group">
                <label for="f-kode">Kode Supplier <span class="required">*</span></label>
                <input type="text" id="f-kode" value="${e(d.kode)}" placeholder="contoh: SUP-001" />
            </div>
            <div class="form-group">
                <label for="f-nama">Nama Supplier <span class="required">*</span></label>
                <input type="text" id="f-nama" value="${e(d.nama)}" placeholder="Nama perusahaan supplier" required />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="email" id="f-email" value="${e(d.email)}" placeholder="supplier@company.com" />
            </div>
            <div class="form-group full-width">
                <label for="f-alamat">Alamat</label>
                <textarea id="f-alamat" placeholder="Alamat lengkap supplier">${e(d.alamat)}</textarea>
            </div>
            <div class="form-group full-width">
                <label for="f-deskripsi">Deskripsi / Catatan</label>
                <textarea id="f-deskripsi" placeholder="Catatan tentang supplier">${e(d.deskripsi)}</textarea>
            </div>
        </div>
    `,
    renderCard: (e, item) => `
...
export { CrudPage as SupplierPage, initCrudPage as initSupplierPage };
